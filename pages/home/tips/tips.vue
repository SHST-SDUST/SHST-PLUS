    ...
    export default {
        ...
        created: function() {
            uni.$app.onload(() => {
                ...
                this.article = this.$store.state.initData.articleName;
                this.articleUrl = this.$store.state.initData.articleUrl;
                this.adSelect = this.$store.state.initData.adSelect.tips;
                this.adShow = false;
                this.getTable();
