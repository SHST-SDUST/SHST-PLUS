<template>
    <view>
        <layout v-if="edit !== -2" title="添加课程">
            <view class="a-flex">
                <view class="a-input-con-line a-mb y-center a-mt a-flex-full">
                    <view>课程名:</view>
                    <input v-model="unit.className" class="a-input" placeholder="必填" />
                </view>
                <view class="a-input-con-line a-mb y-center a-flex-full">
                    <view>教室:</view>
                    <input v-model="unit.classroom" class="a-input" placeholder="必填" />
                </view>
            </view>
            <view class="a-flex">
                <view class="a-input-con-line a-mb y-center a-flex-full">
                    <view>教师名:</view>
                    <input v-model="unit.teacherName" class="a-input" placeholder="选填" />
                </view>
                <view class="a-input-con-line a-mb y-center a-flex-full">
                    <picker
                        class="x-full"
...
import { propsCopy } from "@/modules/copy";
export default {
    components: { headslot },
    filters: {},
    data: () => ({
